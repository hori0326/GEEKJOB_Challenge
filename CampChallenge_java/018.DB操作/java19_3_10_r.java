 ...
 * @author hori
 */
public class java19_3_10_r extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            pstmt.setString(1, request.getParameter("deleteID"));
            ...
            out.print("<br>プロフィールIDが、 " + request.getParameter("deleteID") + " のデータを削除しました");
