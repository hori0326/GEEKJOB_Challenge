 ...
 * @author hori
 */
public class java19_3_11_r extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            pstmt = conn.prepareStatement("UPDATE profiles SET name = ?, tell = ?, age = ? , birthday = ? WHERE profilesID = ?");

            pstmt.setString(1, request.getParameter("name"));
            pstmt.setString(2, request.getParameter("tell"));
            pstmt.setInt(3, Integer.parseInt(request.getParameter("age")));
            pstmt.setString(4, request.getParameter("birthday"));
            pstmt.setInt(5, Integer.parseInt(request.getParameter("profilesID")));
