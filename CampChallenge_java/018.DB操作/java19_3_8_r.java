 ...
 * @author hori
 */
public class java19_3_8_r extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("searchName").equals("")){
            ...
            try {
                ...
                pstmt = conn.prepareStatement("SELECT * FROM profiles WHERE name LIKE ?");
                pstmt.setString(1, "%" + request.getParameter("searchName") + "%");
